...
private:
    ...
    uint32_t        m_format;                  ///< Format of the internal sound buffers
    bool          m_loop;                    ///< Loop flag (true to loop, false to play once)
    uint64_t        m_samplesProcessed;        ///< Number of buffers processed since beginning of the stream
...
///     }
///
///     virtual void onSeek(uint32_t timeOffset)
///     {

...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromSamples(const int16_t *samples, uint64_t sampleCount, unsigned int channelCount, unsigned int sampleRate);
    ...
    /// (uint16_t). The total number of samples in this array
...
private:
    ...
    std::vector<int16_t> m_samples;  ///< Samples buffer
